document.addEventListener('DOMContentLoaded', function () {
    ...
    BTN_TOGGLE_NOW.addEventListener('click', () => {
        ...
        if(FRIENDS_NOW.classList.contains('friend_list_hide')) {
            BTN_TOGGLE_NOW_IMG.src = "./img/btn_triangle_updown.png";
        } else {
            BTN_TOGGLE_NOW_IMG.src = "./img/btn_triangle.png";
        }
    });
    ...
    BTN_TOGGLE_RECOMMEND.addEventListener('click', () => {
        ...
        if(FRIENDS_RECOMMEND.classList.contains('friend_list_hide')) {
            BTN_TOGGLE_RECOMMEND_IMG.src = "./img/btn_triangle_updown.png";
        } else {
            BTN_TOGGLE_RECOMMEND_IMG.src = "./img/btn_triangle.png";
        }
    });
