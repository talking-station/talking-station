document.addEventListener('DOMContentLoaded', function () {
    const BTN_HEADER = document.querySelector('#btnToggleHeader') as HTMLElement; // header ▼ 버튼
    const COMMENT = document.querySelector('.profile_comment') as HTMLElement;
    const HEADER_CONTENT = document.querySelector('.header_box') as HTMLElement;
    const PROFILE_IMG = document.querySelector('.profile_img') as HTMLElement;

    const BTN_TOGGLE_NOW = document.querySelector('#btnToggleNow') as HTMLElement; // 친구 목록 ▼ 버튼
    ...
    const FRIENDS_NOW = document.querySelector('#friends_now') as HTMLElement; // 친구 전체 리스트
    ...
    const MODAL = document.querySelector('.modal_container') as HTMLElement;

    const BTN_MORE = FRIENDS_NOW.querySelector('.show_more') as HTMLElement; // 더보기 버튼
    const BTN_LESS = FRIENDS_NOW.querySelector('.show_less') as HTMLElement; // 간략히 버튼
    ...
    BTN_TOGGLE_NOW.addEventListener('click', () => {
        ...
        if (BTN_TOGGLE_NOW_IMG instanceof HTMLImageElement) {
